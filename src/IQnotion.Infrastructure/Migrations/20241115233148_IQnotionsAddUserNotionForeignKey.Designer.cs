...
namespace IQnotion.Infrastructure.Migrations
{
    ...
    [Migration("20241115233148_IQnotionsAddUserNotionForeignKey")]
    partial class IQnotionsAddUserNotionForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IQnotion.ApplicationCore.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IQnotion.ApplicationCore.Models.UserNotion", b =>
                {
                    b.HasOne("IQnotion.ApplicationCore.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("IQnotion.ApplicationCore.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
